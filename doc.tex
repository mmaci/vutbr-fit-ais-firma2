...
\begin{center}
	...
	\captionof{figure}{Sekvenční diagram UC Uzavření termínu}
\end{center}

\begin{center}
	\captionsetup{type=figure}
	\includegraphics[width=17cm]{img/pridani-terminu.pdf}
	\captionof{figure}{Sekvenční diagram UC Přidání termínu}
\end{center}

\begin{center}
	\captionsetup{type=figure}
	\includegraphics[width=17cm]{img/prihlaseni-na-termin-seq.pdf}
	\captionof{figure}{Sekvenční diagram UC Příhlášení na termín}
\end{center}
