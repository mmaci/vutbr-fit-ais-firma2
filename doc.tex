...
\chapter{Architektura}
		...
		\begin{center}
			...
			\captionof{figure}{Návrh diagramu tříd}
		\end{center}
		
\chapter{Interakce mezi obrazovkami}
		% ----------- interakce  -----------
		\begin{center}
			\captionsetup{type=figure}
			\includegraphics[height=18cm]{img/backend-obr.pdf}
			\captionof{figure}{Interakce mezi obrazovkami - Back End / Administrační rozhraní}
		\end{center}
		
		\begin{center}
			\captionsetup{type=figure}
			\includegraphics[height=18cm]{img/frontend-obr.pdf}
